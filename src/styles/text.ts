...
import { createStyle, createVars } from "../lib";
...
createStyle(["html"], {
  fontSize: textVars.htmlFontSize,
});
...
createStyle(["h1"], {
  fontSize: textVars.heading.fontSizes.h1,
});

createStyle(["h2"], {
  fontSize: textVars.heading.fontSizes.h2,
});

createStyle(["h3"], {
  fontSize: textVars.heading.fontSizes.h3,
});

createStyle(["h4"], {
  fontSize: textVars.heading.fontSizes.h4,
});

createStyle(["h5"], {
  fontSize: textVars.heading.fontSizes.h5,
});

createStyle(["h6"], {
  fontSize: textVars.heading.fontSizes.h6,
});
...
createStyle(["ul ul,ol ol"], {
  margin: textVars.list.nestedMargin,
});

// Blockquote
createStyle(["blockquote"], {
